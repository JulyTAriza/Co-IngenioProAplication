...
export default function CreateProjectModal({
  ...
  }, [proyecto, cities, clients, isOpen, resetForm]); // Agregar isOpen y resetForm
            ...
            <>
              <div>
                ...
                <input
                  type="email"
                  name="email_cliente"
                  value={formData.email_cliente || ""} // Asegurar que nunca sea undefined
                  onChange={handleChange}
                  className={inputCss}
                  required
                />
              ...
              <div>
                ...
                <input
                  ...
                  value={formData.telefono_cliente || ""} // Asegurar que nunca sea undefined
                  onChange={handleChange}
                  className={inputCss}
                  required
                />
              ...
              <div className="col-span-2">
                ...
                <input
                  ...
                  value={formData.direccion_cliente || ""} // Asegurar que nunca sea undefined
                  onChange={handleChange}
                  className={inputCss}
                  required
                />

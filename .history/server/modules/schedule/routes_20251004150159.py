...
# ---------------------------
@cronograma_bp.route("/<int:id_proyecto>/etapas", methods=["GET"])
@token_required
...
# ---------------------------
@cronograma_bp.route("/etapas/<int:id_etapa>/actividades", methods=["GET"])
@token_required
...
# ---------------------------
@cronograma_bp.route("/etapas/<int:id_etapa>/actividades", methods=["POST"])
@token_required
...
# ---------------------------
@cronograma_bp.route("/actividades/<int:id_actividad>", methods=["PUT"])
@token_required
...
# ELIMINAR ACTIVIDAD
# ---------------------------
@cronograma_bp.route("/actividades/<int:id_actividad>", methods=["DELETE"])
@token_required
...
# ---------------------------
@cronograma_bp.route("/<int:id_proyecto>/gantt", methods=["GET"])
@token_required
def obtener_cronograma_completo(current_user, id_proyecto):
    """
    Retorna estructura jerárquica para visualizar el cronograma tipo Gantt:
    [
      {
        "id_etapa": 1,
        "nombre": "Diseño",
    ...
    try:
        ...
        current_app.logger.error("Error obteniendo cronograma completo:\n%s", traceback.format_exc())
        return jsonify(success=False, message="Error interno del servidor"), 500

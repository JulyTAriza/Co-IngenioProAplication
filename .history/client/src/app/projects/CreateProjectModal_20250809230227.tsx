    ...
    <div className="fixed inset-0 bg-gray-600 bg-opacity-50 z-20 flex items-center justify-center">
      <div className="bg-white rounded-lg shadow-lg w-[700px] p-6 relative">
        ...
        <form onSubmit={handleSubmit} className="mt-4 grid grid-cols-2 gap-4">
          ...
          {/* Datos del Proyecto */}
          <h3 className={sectionTitleCss}>Project Details</h3>
          <div>
          ...
          {/* Ubicación */}
          <h3 className={sectionTitleCss}>Location</h3>
          <div>
          ...
          {/* Materiales */}
          <h3 className={sectionTitleCss}>Materials</h3>
          ...
          {/* Fechas */}
          <h3 className={sectionTitleCss}>Dates</h3>
          <div>
          ...
          {/* Presupuesto */}
          <h3 className={sectionTitleCss}>Budget</h3>
          <div>

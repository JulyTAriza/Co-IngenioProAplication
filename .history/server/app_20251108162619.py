...
# -------------------------
# CONFIGURACIÓN CORS SIMPLIFICADA (EVITA DUPLICADOS)
# -------------------------

# Configuración SIMPLE de CORS - sin manejo manual duplicado
CORS(
    app,
    origins=[
        "http://localhost:3000",
...
logger.info("🌐 CORS configurado correctamente (configuración simplificada).")

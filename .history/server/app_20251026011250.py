...
CORS(
    app,
    origins=["http://localhost:3000", "http://127.0.0.1:3000","https://*.up.railway.app"],
...
if __name__ == '__main__':
    ...
    # Usar Waitress como servidor de producción en Render
    if os.environ.get('RENDER'):
        from waitress import serve
        print(f"🚀 Iniciando servidor de producción en puerto {port}")
        serve(app, host='0.0.0.0', port=port)
    else:
        # En desarrollo, usar Flask dev server

...
import { CheckCircle2, Circle, Calendar, FolderOpen, Layers, ArrowRight, Search } from "lucide-react";
...
const MyTasks = () => {
  ...
  const displayPending = filter === "completed" ? [] : filteredPending;
  const displayCompleted = filter === "pending" ? [] : filteredCompleted;
        ...
        <div className="flex-1 max-w-md">
          <div className="relative">
            ...
            <input
              ...
              placeholder="Buscar tareas por nombre, descripción, proyecto..."
              value={searchTerm}
          ...
          <div className="bg-white rounded-lg shadow-sm p-4">
            <div className="flex items-center gap-2 mb-4 pb-3 border-b">
              ...
              <h2 className="text-lg font-bold text-gray-800">
                Por Hacer ({displayPending.length})
              </h2>
            </div>
            ...
            <div className="space-y-3 max-h-[600px] overflow-y-auto">
              {displayPending.length === 0 ? (
                <p className="text-center text-gray-400 py-8">
                  {searchTerm 
                    ? "No se encontraron tareas pendientes que coincidan con la búsqueda" 
        ...
        {filter !== "pending" && (
          <div className="bg-white rounded-lg shadow-sm p-4">
            <div className="flex items-center gap-2 mb-4 pb-3 border-b">
              ...
              <h2 className="text-lg font-bold text-gray-800">
                Completadas ({displayCompleted.length})
              </h2>
            </div>
            ...
            <div className="space-y-3 max-h-[600px] overflow-y-auto">
              {displayCompleted.length === 0 ? (
                <p className="text-center text-gray-400 py-8">
                  {searchTerm 
                    ? "No se encontraron tareas completadas que coincidan con la búsqueda" 

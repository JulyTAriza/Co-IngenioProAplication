...
const Dashboard = () => {
  ...
  const progresoPromedio = progressSummary?.averageProgress || 0;
      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-6">
          ...
          <MetricCard
            ...
            trend={{ value: Math.round(progresoPromedio), label: "progreso promedio" }}
          />
          ...
          <div className="bg-gradient-to-br from-blue-500 to-blue-700 rounded-3xl p-6 text-white">
            ...
            <div className="space-y-2">
              ...
              {materialesStockBajo > 0 && (
                <div className="bg-orange-500 bg-opacity-30 rounded-xl p-3 text-sm flex items-center gap-2">
                  <AlertTriangle className="w-4 h-4" />
                  <span>{materialesStockBajo} items con stock bajo</span>
                </div>
              )}
            </div>
          </div>

...
interface CreateProjectModalProps {
  ...
  proyecto: any | null; // null = crear, objeto completo = editar
}
...
export default function CreateProjectModal({
  ...
  // Si estamos editando, precargar datos - IGUAL QUE EL MODAL DE MATERIALES
  useEffect(() => {
    if (proyecto) {
      console.log("📋 Cargando datos del proyecto:", proyecto);
      
      setFormData({
        nombre: proyecto.nombre || "",
        descripcion: proyecto.descripcion || "",
        nombre_ciudad: proyecto.nombre_ciudad || "",
        departamento: proyecto.departamento || "",
        nombre_cliente: proyecto.nombre_cliente || "",
        email_cliente: proyecto.email_cliente || "",
        ...
        presupuesto: String(proyecto.presupuesto ?? ""),
        ...
        <form onSubmit={handleSubmit} className="mt-4 grid grid-cols-2 gap-4">
          ...
          <div>
            ...
            <Autocomplete
              ...
              value={cities.find((c) => 
                c.nombre === formData.nombre_ciudad && 
                c.departamento === formData.departamento
              ) || null}
              onChange={(_, newValue) =>
                setFormData((prev) => ({
                  ...prev,

...
const Dashboard = () => {
  ...
  const proyectosCompletados = proyectos.filter(p => p.estado === 'Finalizada').length;
              ...
              <div className="relative" style={{ width: '200px', height: '200px' }}>
                <svg viewBox="0 0 200 200" className="w-full h-full transform -rotate-90">
                  ...
                  <circle
                    ...
                    stroke="#A855F7"
                    strokeWidth="24"
                    strokeDasharray={`${(proyectosCompletados / totalProyectos) * 502.4} 502.4`}
                    strokeLinecap="round"
                  ...
                  <circle
                    ...
                    stroke="#3B82F6"
                    strokeWidth="24"
                    strokeDasharray={`${(proyectosActivos / totalProyectos) * 502.4} 502.4`}
                    strokeDashoffset={`-${(proyectosCompletados / totalProyectos) * 502.4}`}
                    strokeLinecap="round"
                    className="transition-all duration-500"
                  />
                </svg>

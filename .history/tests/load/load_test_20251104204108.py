...
EVIDENCE_DIR = os.path.join("tests", "load_evidence")
...
def progressive_load(endpoint="/projects", max_threads=500, step=50):
    ...
    Guarda evidencia de cada bloque de carga.
    """
    ...
    # Guardar resumen de toda la prueba
    ...
    print("\nPrueba de carga completa. Resumen guardado.")

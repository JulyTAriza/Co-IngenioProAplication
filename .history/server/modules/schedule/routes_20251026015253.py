...
# ---------------------------
@schedule_bp.route("/verificar-vencimientos", methods=["POST", "OPTIONS"])
@token_required
...
def handle_options():
    if request.method == 'OPTIONS':
        ...
        response.headers.add('Access-Control-Allow-Origin', 'https://co-ingeniopro.up.railway.app')

    ...
    <Link href={href} onClick={handleClick}>
      <div
        ...
        hover:text-blue-600 hover:bg-blue-50 gap-3 transition-all duration-200 ${
          ...
          isOperario && !['/dashboardoperario', '/my-task', '/settings'].includes(href) 
...
const Sidebar = () => {
  ...
  const allLinks = [
    {
      href: isOperario ? "/dashboardoperario" : "/dashboard", // ← CAMBIO IMPORTANTE AQUÍ
      icon: Layout,
      label: "Dashboard",

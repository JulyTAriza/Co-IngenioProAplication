...
# ACTUALIZAR USUARIO (INCLUYENDO CAMBIO DE ROL) - CON PROTECCIÓN PARA ADMINISTRADOR PRINCIPAL
...
def update_user(current_user, user_id):
    ...
    try:
        ...
        # 1️⃣ Verificar si el usuario a modificar es el ADMIN PRINCIPAL (ID 1)
        if user_id == 1:
            conn.close()
            return jsonify({
                "success": False, 
        ...
        roles_permitidos = ['Operario', 'Administrador']
        ...
        if nuevo_rol != rol_actual and email_actual:
            datos_correo = {
                ...
                "rol_nuevo": nuevo_rol,
                "dashboard_url": "http://localhost:3000/dashboard"  # Cambia por tu URL real
            }

...
# ✅ USAR after_request EN VEZ DE before_request
...
def get_projects_progress(current_user):
    ...
    try:
        ...
        cursor.execute("""
            ...
            GROUP BY p.id_proyecto, p.nombre_proyecto, p.estado, p.fecha_inicio, p.fecha_fin
...
def get_project_detail(current_user, project_id):
    ...
    try:
        ...
        project_info = {
            ...
            "startDate": project_row[3],
            "endDate": project_row[4],
            "totalTasks": total,
            "completedTasks": completed,
            "percentage": percentage
        }

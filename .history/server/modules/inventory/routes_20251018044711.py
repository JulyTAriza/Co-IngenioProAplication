...
def get_stock_comparison(current_user):
    ...
    try:
        ...
        # CONSULTA CORREGIDA - Remover el HAVING para incluir todos los materiales
        cursor.execute("""
            SELECT 
                m.id,
                m.nombre,
        ...
        for r in rows:
            current_stock = r[2]
            estimated_need = float(r[3]) if r[3] else 0
            difference = current_stock - estimated_need

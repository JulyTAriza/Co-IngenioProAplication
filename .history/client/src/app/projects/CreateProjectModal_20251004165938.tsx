...
export default function CreateProjectModal({
  ...
  const handleSubmit = async (e: FormEvent<HTMLFormElement>) => {
    ...
    try {
      ...
      if (proyecto) {
        // EDITAR - Enviar como objetos (el backend los convierte a JSON)
        payload = {
        ...
        // CREAR - CORREGIDO: Verificar estructura exacta
        payload = {
          nombre: formData.nombre.trim(),
          descripcion: formData.descripcion.trim(),
          nombre_ciudad: formData.nombre_ciudad.trim(), // Solo nombre, sin departamento
        ...
        // DEBUG: Verificar que no haya valores undefined
        console.log("🔍 DEBUG - Payload verificado:", {
      ...
      try {
        ...
        throw new Error("Los datos del proyecto contienen valores no válidos para JSON");
      }
              ...
              <Autocomplete
                ...
                onChange={(_, newValue) =>
                  setFormData((prev) => ({
                    ...
                    nombre_ciudad: newValue ? newValue.nombre : "", // Solo el nombre

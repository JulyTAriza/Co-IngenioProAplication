...
export default function CreateProjectModal({
  ...
  const handleSubmit = async (e: FormEvent<HTMLFormElement>) => {
    ...
    // Validar que todos los miembros del equipo tengan rol
      ...
      if (proyecto) {
        ...
        payload = {
          ...
          materiales: formData.materiales.map(mat => ({
            ...
            id_etapa: null, // El SP maneja la creación de etapas
            nombre_etapa: mat.nombre_etapa || null
          }))
        };
      } else {
        // Payload para crear nuevo proyecto - CORREGIDO
        payload = {
          nombre: formData.nombre.trim(),
          descripcion: formData.descripcion.trim(),
          ...
          materiales: formData.materiales.map(mat => ({
            ...
            unidad: mat.unidad,
            costo_unitario: Number(mat.costo_unitario),
            id_etapa: null, // Siempre null para nuevos proyectos
            nombre_etapa: mat.nombre_etapa || null
          }))
        };
      }

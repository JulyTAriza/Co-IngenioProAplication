...
export const api = createApi({
  ...
  tagTypes: ["DashboardMetrics", "Material", "Users", "Expenses","Notifications", "Projects","ProjectDetail","Schedule","MyTasks","Progress","Inventory"],
  endpoints: (build) => ({
...
// Cambiar contraseña (desde configuraciones)

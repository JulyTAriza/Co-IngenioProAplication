...
# -------------------------
# ACTUALIZAR PROYECTO (CON DEBUG COMPLETO)
# -------------------------
...
def actualizar_proyecto(current_user, proyecto_id):
    ...
    try:
        ...
        print(f"✅ Proyecto {proyecto_id} actualizado exitosamente")
...
def obtener_proyecto_detalle(current_user, proyecto_id):
    try:
        ...
        print(f"✅ [PROYECTO-DETALLE] Datos preparados: {len(detalle.get('materiales', []))} materiales, {len(detalle.get('equipo', []))} equipo")

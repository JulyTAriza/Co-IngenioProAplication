      ...
      <div className="max-w-7xl mx-auto">
          ...
          <div className="bg-white rounded-3xl p-6 shadow-sm border border-gray-100">
            ...
            <div className="flex items-center gap-2 text-sm">
              <span className="flex items-center text-green-600 font-medium">
                ...
                {proyectosFinalizados} {/* CORREGIDO */}
              </span>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-4 gap-6 mb-6">
          ...
          <div className="bg-gradient-to-br from-pink-400 via-pink-500 to-pink-600 rounded-3xl p-6 text-white shadow-lg">
            ...
            <div className="text-4xl font-bold mb-1">{proyectosEnProgreso + proyectosPlanificacion}</div> {/* CORREGIDO */}
            <p className="text-sm opacity-90">{proyectosFinalizados} completados</p> {/* CORREGIDO */}
              ...
              <div className="relative" style={{ width: '200px', height: '200px' }}>
                <svg viewBox="0 0 200 200" className="w-full h-full transform -rotate-90">
                  ...
                  <circle
                    ...
                    r="80"
                    fill="none"
                    stroke="#10B981" // Verde para finalizados
                    strokeWidth="24"
                  ...
                  <circle
                    ...
                    r="80"
                    fill="none"
                    stroke="#F59E0B" // Amarillo para en progreso
                    strokeWidth="24"
                  ...
                  <circle
                    ...
                    r="80"
                    fill="none"
                    stroke="#3B82F6" // Azul para planificación
                    strokeWidth="24"

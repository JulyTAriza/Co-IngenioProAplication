...
import { Plus, ChevronLeft, ChevronRight, Calendar, Edit2, Trash2, X, Save, User } from 'lucide-react';
import { 
...
function ModalActividad({ isOpen, onClose, idEtapa, actividadEdit }: ModalActividadProps) {
...
export default function CronogramaGantt({ idProyecto }: { idProyecto: number }) {
  ...
  const { data: ganttData, isLoading, error } = useGetGanttProyectoQuery(idProyecto);
    ...
    return (
      <div className="min-h-screen bg-gray-50 flex items-center justify-center">
        <div className="bg-red-50 border border-red-200 rounded-lg p-6 max-w-md">
          ...
          <p className="text-red-600">No se pudo conectar con el servidor. Verifica tu conexión.</p>
        </div>
      </div>
    );
  }

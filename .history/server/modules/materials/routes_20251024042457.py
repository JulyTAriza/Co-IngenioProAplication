...
def delete_material(current_user, material_id):
    ...
    try:
        ...
        # 🔹 Eliminar primero las referencias en materiales_etapa
        cursor.execute("DELETE FROM materiales_etapa WHERE id_material = ?", (material_id,))
        ...
        return jsonify(success=True, message=f"Material '{material[0]}' y sus relaciones fueron eliminados."), 200

...
const Inventory = () => {
  ...
  const comparisonColumns: GridColDef[] = [
    ...
    { 
      ...
      renderCell: (params) => (
        <div className="text-center">
          <div className="text-lg font-bold text-blue-600">{params.value}</div>
    ...
    { 
      ...
      renderCell: (params) => (
        <div className="text-center">
          <div className="text-lg font-bold text-orange-600">{params.value}</div>
          <div className="text-xs text-gray-500">unidades</div>
        </div>
      )
    },
  ...
  return (
    <div className="min-h-screen bg-gray-50 p-6">
      ...
      <div className="bg-white rounded-lg shadow-sm">
        ...
        {/* COMPARACIÓN STOCK VS ESTIMADO - NUEVO DISEÑO EN GRILLA */}
        {activeTab === "comparison" && (
          <div className="p-4">
            <h2 className="text-xl font-bold text-gray-800 mb-6">
              Stock Actual vs Consumo Estimado
            </h2>

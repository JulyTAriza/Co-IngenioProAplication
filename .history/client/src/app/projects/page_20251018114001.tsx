...
const ProjectsPage = () => {
  ...
  useEffect(() => {
    console.log("🔍 [PAGE-DEBUG] useEffect detalles - Estado:", {
      ...
      responseId: proyectoDetalleResponse?.data?.id_proyecto
    });
    ...
    if (proyectoDetalleResponse && !loadingDetalle && proyectoIdParaDetalle) {
      ...
      const respuestaId = proyectoDetalleResponse.data?.id_proyecto;
      ...
      if (respuestaId && respuestaId === solicitadoId) {
        ...
        setSelectedProyecto(proyectoDetalleResponse.data);
        setIsModalOpen(true);
